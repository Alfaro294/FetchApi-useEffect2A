    ...
    return (
        <div>
            ...
            {loading ? (
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4'>{characters.map((character)=> (<DragonBallCard key={character.id} character={character}></DragonBallCard>))}  </div>
            )}
        </div>
    )
}
